...
public class Process {
    ...
    public Process(int pid, int arrTime, int burtTime, int compTime, int turnArrTime, int waitingTime) {
        this.pid = pid;
    ...
    public Process(int pid, int arrTime, int burtTime, int compTime, int turnArrTime, int waitingTime, int focusCheck) {
        this.pid = pid;
        this.arrTime = arrTime;
        this.burtTime = burtTime;
        this.compTime = compTime;
